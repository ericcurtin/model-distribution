...
import (
	...
	"github.com/docker/model-distribution/internal/safetensors"
...
// FromSafeTensors returns a *Builder that builds a model artifacts from a SafeTensors file
func FromSafeTensors(path string) (*Builder, error) {
	mdl, err := safetensors.NewModel(path)
	if err != nil {
		return nil, err
	}
	return &Builder{
